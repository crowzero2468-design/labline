    ...
    <footer class="footer-custom">
      <div class="footer-left">
        <span class="footer-logo">
          <i class="bi bi-asterisk"></i> LABLINE INC.
        </span>
        <span class="footer-separator">|</span>
        <span class="footer-copy">&copy; 2026 Made with <i class="bi bi-heart-fill text-danger footer-heart"></i> by<a
            href="https://www.facebook.com/juicewa0" target="_blank">Joshua Pagulayan</a>• All rights reserved.</span>
      </div>
  ...
  <script src="<?= base_url('assets/libs/jquery/jquery.min.js') ?>"></script>
    <script src="<?= base_url('assets/data_table/dataTables.js') ?>"></script>
<script src="<?= base_url('assets/data_table/dataTables.bootstrap5.js') ?>"></script>
